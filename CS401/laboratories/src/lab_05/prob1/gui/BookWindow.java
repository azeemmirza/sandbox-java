package lab_05.prob1.gui;

import lab_05.prob1.rulesets.RuleException;
import lab_05.prob1.rulesets.RuleSet;
import lab_05.prob1.rulesets.RuleSetFactory;
    ...
    class ButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
            try {
                ...
                JOptionPane.showMessageDialog(BookWindow.this, "Book data is valid!");
            } catch (RuleException e) {
                JOptionPane.showMessageDialog(BookWindow.this, e.getMessage(), "Rule Violation", JOptionPane.ERROR_MESSAGE);
            }
