...
public class Triangle extends ClosedCurve {
		...
		public Triangle(double base, double height) throws IllegalClosedCurveException{
			if( base < 0 || height < 0) throw new IllegalClosedCurveException("IllegalClosedCurveException was thrown in a Triangle instance ");
			this.base = base;
			this.height = height;
		}
		...
		public Triangle(double side1, double side2, double side3) throws IllegalClosedCurveException  {
			...
			if(x + y < z) {
				...
				throw new IllegalClosedCurveException("The three sides do not form a triangle");
			}
			else {	
				setSides(x,y,z);
